  ...
  return (
    <div className='min-h-screen bg-gray-50'>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='flex items-center justify-between h-16'>
            <div className='flex items-center'>
              <h1 className='text-2xl font-bold text-gray-900'>Energy Market Visualization</h1>
              <span className='ml-3 text-sm text-gray-500'>Real-time market data</span>
            </div>
      ...
      <main className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
        ...
        {/* Energy Prices Grid */}
        <div className='mb-6'>
          <h2 className='text-xl font-semibold text-gray-800 mb-4'>Current Energy Prices</h2>
